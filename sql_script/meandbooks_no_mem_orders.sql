...
--
-- Table structure for table `no_mem_orders`
--

DROP TABLE IF EXISTS `no_mem_orders`;
...
--
-- Dumping data for table `no_mem_orders`
--

LOCK TABLES `no_mem_orders` WRITE;
/*!40000 ALTER TABLE `no_mem_orders` DISABLE KEYS */;
/*!40000 ALTER TABLE `no_mem_orders` ENABLE KEYS */;
UNLOCK TABLES;
